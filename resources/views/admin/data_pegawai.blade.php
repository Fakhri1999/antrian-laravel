...
<head>
  ...
  <title>Antrianku - Dashboard</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <a href="#" class="mb-0 btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50" data-toggle="modal" data-target="#exampleModal"></i> Tambah Petugas</a>
          </div>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Antrianku  </span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
