...
<div class="container-fluid">
  ...
  <input type="hidden" id="nomor_loket" value="{{session('nomor_loket')}}">
  <!-- Page Heading -->
  <div class="row">
    <div class="col-12">
      <div id="loader">
          ...
          <div class="row rowKepuasan">
            <div class="col-lg-6">
              <a href="javascrip:void">
                <img src="{{asset('img/happy.png')}}" alt="" width="40%" class="mx-auto d-block tombol"
                  data-kepuasan="PUAS">
              </a>
            ...
            <div class="col-lg-6">
              <a href="javascrip:void">
                <img src="{{asset('img/sad.png')}}" alt="" width="40%" class="mx-auto d-block tombol"
                  data-kepuasan="TIDAK PUAS">
              </a>
